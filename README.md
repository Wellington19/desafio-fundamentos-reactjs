...
Essa é uma aplicação que irá se conectar com backend do [Desafio 06](https://github.com/Wellington19/desafio-database-upload), para exibir as transações criadas e permitir a importação de um arquivo CSV para gerar novos registros no banco de dados, seguindo os requisitos propostos logo abaixo pelo desafio 7 do bootcamp GoStack da Rocketseat.
...
- **`Importar arquivos CSV`**: Na sua página `Import`, você deve permitir o envio de um arquivo no formato `csv` para o seu backend, que irá fazer a importação das transações para o seu banco de dados. O arquivo csv deve seguir o seguinte [modelo](https://github.com/Wellington19/desafio-database-upload/blob/master/assets/file.csv).
